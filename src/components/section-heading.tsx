...
const DEFAULT_BADGE_ICON = <Sparkles className="h-4 w-4" />;

const TITLE_SIZE: Record<SectionHeadingSize, string> = {
  sm: cn("text-3xl", "md:text-4xl"),

  md: cn("text-4xl", "md:text-5xl"),

  lg: cn("text-4xl", "md:text-5xl", "xl:text-6xl"),
};

const DESCRIPTION_SIZE: Record<SectionHeadingSize, string> = {
  sm: "text-base",
...
const ALIGNMENT: Record<SectionHeadingAlign, string> = {
