...
export function AboutStats({ about, className }: AboutStatsProps) {
  const stats = [...about.stats];

  if (
    typeof about.yearsOfExperience === "number" &&
    about.yearsOfExperience > 0 &&
    !stats.some((item) => item.label.toLowerCase().includes("experience"))
  ) {
    stats.unshift({
      label: "Experience",
  ...
  return (
    <section aria-labelledby="about-stats" className={cn(className)}>
      <h3 id="about-stats" className="sr-only">
        About statistics
      </h3>
