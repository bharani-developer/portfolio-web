...
interface SkillProgressProps {
  ...
  readonly color?: "cyan" | "emerald" | "violet" | "orange" | "blue" | "pink";
...
export function SkillProgress({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={cn("font-bold tracking-tight text-white", config.text)}
        >
          {progress}
          {showValue && (
            <span className="ml-0.5 text-[0.75em] text-slate-400">%</span>
          )}
        </span>
      </motion.div>
    </div>
